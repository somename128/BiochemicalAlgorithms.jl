...
function generate_record(A::Array{Float32,3}, rotation::QuaternionF32, roomcoordinates::Vector{Vector3{Float32}}, centroids::Array{Meshes.Point3, 3}, gridsize::Int32)
