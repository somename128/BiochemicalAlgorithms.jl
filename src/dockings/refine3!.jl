...
function refine3!(results_docking::Tuple{DataFrame, Array{ComplexF32, 3}, Vector{Tuple{String, Vector3{Float32}}}, Array{Meshes.Point3f, 3}, Int32, Int32}, runs::Int32, vdW::Bool)
    ...
    # sample quaternions von Mieses Fischer distributed around best quaternion
    rotations = Array{Vector{Float32}}(undef, runs)
    for i in 1:runs
        rotations[i] = sampleVMF(μ, λ)
    end
